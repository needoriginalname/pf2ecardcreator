...
const weaponTemplate = {
  ...
  placeholders: {
    ...
    traits: 'Versatile P',
    action: 'Weapon',
    description: 'Weapon description and special notes',
    artSide: 'Price, damage, hands, bulk, category, group',
  },
  createOverrides: () => ({
    templateId: 'weapon',
    actionIcon: '',
    ...
    description: [
      paragraph("Longswords can be one-edged or two-edged swords. Their blades are heavy and they're between 3 and 4 feet in length."),
      labeledParagraph('Critical Specialization', 'Sword: The target is made off-guard until the start of your next turn.'),
    ],
  }),
}
